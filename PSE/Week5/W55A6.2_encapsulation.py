...
class Student:
    ...
    def update_info(self):  # Additional Method to modify the grade to A+
        self.__grade = "A+"
        return self.__grade
...
print(s.update_info()) # New method can access the private variable to be changed.
print("After Method to update Private Variable")
#print(s.updt_age()) # # New method can access the protected variable to be changed.
#print(s._age)
print(s.get_grade()) # checking the final value of the private variable.
